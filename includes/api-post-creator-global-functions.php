 ...
 */
function api_post_get_max( $array ) {

	return Api_Post_Globals::get_max( $array );
 ...
 */
function api_post_get_svg( $svg ) {

	return Api_Post_Globals::get_svg( $svg );
 ...
 */
function api_post_creator_get_template( $name ) {

	return Api_Post_Globals::get_template( $name );

}

class Api_Post_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'api-post-creator-template-paths', $locations );
